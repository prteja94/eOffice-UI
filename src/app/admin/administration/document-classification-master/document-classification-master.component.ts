...
export class DocumentClassificationMasterComponent implements OnInit{
  ...
  form: FormGroup = new FormGroup({
    classificatonName: new FormControl(''),
    classificatonAribic: new FormControl(''),
  ...
  ngOnInit(): void {
    this.form = this.formBuilder.group(
      {
        classificatonName: ['', Validators.required],
        classificatonAribic: ['', Validators.required],
    ...
    this.columns = [
      ...
      { key: 'classificatonName', title: 'Classificaton Name' },
      { key: 'classificatonNameAr', title: 'Classificaton Name Ar' },
